...
def issue_due_tagalysis_forecasts(*, now: datetime | str | None = None) -> dict[str, Any]:
    ...
    This is deliberately independent of Chad/OpenAI.  It refuses to invent a
    circulating supply or substitute a futures mark for an unavailable DEX
    spot price, and records incomplete evidence as an explicit quality penalty.
    """
