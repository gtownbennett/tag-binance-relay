...
class MultiExchangeService:
    ...
    async def start(self) -> None:
        self.http = httpx.AsyncClient(
            ...
            headers={"User-Agent": "TAGneXt-Relay/tagnext-1.0.0-correction1"},
        )
    ...
    def binance_from_snapshot(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        return self._snapshot(
            ...
            extras={
                ...
                "oiChange24h": _finite(payload.get("oiChange24hPct")),
                "oiChange5mPct": _finite(payload.get("oiChange5mPct")),
                "oiChange15mPct": _finite(payload.get("oiChange15mPct")),
                "oiChange1hPct": _finite(payload.get("oiChange1hPct")),
                "oiChange4hPct": _finite(payload.get("oiChange4hPct")),
                "oiChange24hPct": _finite(payload.get("oiChange24hPct")),
