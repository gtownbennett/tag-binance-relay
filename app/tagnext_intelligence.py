...
DEFAULT_PROVIDERS: tuple[Provider, ...] = (
    ...
    Provider("nodereal", "NodeReal MegaNode", "on-chain-adapter", "archive-bsc-rpc", True, "exact_bsc_capability_verified_signup_blocked", False, "Free/no-card BSC archive RPC is documented; account creation requires unavailable Chrome control."),
    ...
    Provider("coinalyze", "Coinalyze", "derivatives-adapter", "oi+funding+liquidations+long-short", True, "exact_tagusdt_verified_signup_blocked", False, "Official TAG/USDT perpetual pages prove coverage; free API signup requires unavailable Chrome control."),
