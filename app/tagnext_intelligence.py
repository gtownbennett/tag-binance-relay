...
DEFAULT_PROVIDERS: tuple[Provider, ...] = (
    ...
    Provider("nodereal", "NodeReal MegaNode", "on-chain-adapter", "archive-bsc-rpc", True, "adapter_ready_waiting_for_credentials", False, "Bounded exact-contract probe is implemented and secret-safe; free/no-card account and key creation remain required."),
    ...
    Provider("coinalyze", "Coinalyze", "derivatives-adapter", "oi+funding+liquidations+long-short", True, "adapter_ready_waiting_for_credentials", False, "Exact TAG/USDT discovery plus bounded OI, funding and liquidation reads are implemented; account and key creation remain required."),
