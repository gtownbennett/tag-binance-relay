...
DEFAULT_PROVIDERS: tuple[Provider, ...] = (
    ...
    Provider("nodereal", "NodeReal MegaNode", "on-chain-adapter", "archive-bsc-rpc", True, "waiting_for_credentials", False),
    Provider("moralis", "Moralis", "on-chain-adapter", "indexed-token+wallet-history", True, "evaluated_not_integrated", False),
    Provider("coinalyze", "Coinalyze", "derivatives-adapter", "oi+funding+liquidations+long-short", True, "waiting_for_credentials", False),
