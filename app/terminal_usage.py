...
def project_scheduler_database_usage(
    *, schedule_interval_seconds: int = 600,
    schedule_statements_per_cycle: int = 904,
    hourly_additional_statements: int = 1_563,
    steady_idle_poll_seconds: int = 120,
    daily_capacity: int = 200_000,
) -> dict[str, int | bool]:
...
class UsageGovernor:
    ...
    def __init__(self) -> None:
        ...
        self._limits = {
            ...
            "database_query": (
                env_int("DATABASE_DAILY_QUERY_LIMIT", 200_000),
                env_int("DATABASE_MONTHLY_QUERY_LIMIT", 6_200_000),
            ),
