...
def coverage_rows() -> list[dict[str, Any]]:
    ...
    rows = [
        ...
        _row("nodereal", tag=True, pair=False, value="Archive BSC RPC, including historical logs", api=True, free=True, card=False, trial=False, quota="Free plan: 3 keys; official pages currently conflict between 10M and 100M monthly CU", history=True, storage=True, role="primary-onchain-shadow", account=True, adapter="runtime_shadow_live_deployed", influence=False, decision="deployed on the isolated TAGneXt challenger as a scheduled read-only shadow collector; live device proof passed chain id 56, exact TAG identity, decimals 18, freshness, and positive total supply while forecast influence remained disabled", terms="https://docs.nodereal.io/docs/pricing-plan", evidence=["Official NodeReal pricing and archive documentation list free BNB Smart Chain mainnet archive access.", "A bounded 2026-08-21 live runtime read validated chain id 56, the exact TAG contract, decimals 18 and positive total supply without logging the credential-bearing endpoint.", "Final folded-device acceptance showed NodeReal live and fresh on the isolated challenger with zero forecast influence."]),
        ...
        _row("coinalyze", tag=True, pair=True, value="Cross-exchange OI, funding, liquidations, long/short and OHLCV", api=True, free=True, card=False, trial=False, quota="40 API calls/minute/key; runtime schedule uses four calls per 15-minute collection", history=True, storage=True, role="derivatives-shadow", account=True, adapter="runtime_shadow_live_deployed", influence=False, decision="deployed on the isolated TAGneXt challenger as a scheduled authenticated shadow collector; live device proof showed three exact TAG/USDT perpetuals, OI and funding with fresh state, while unavailable liquidation rows stayed zero and forecast influence remained disabled", terms="https://api.coinalyze.net/v1/doc/", evidence=["Official Coinalyze API documentation defines the authenticated catalog, OI, funding and liquidation endpoints and a 40-call/minute/key limit.", "A bounded 2026-08-21 live runtime read found exact TAG/USDT perpetuals; missing per-market values remain unavailable and header authentication keeps the credential out of URLs and evidence.", "Final folded-device acceptance showed Coinalyze live and fresh on the isolated challenger with three exact TAG/USDT markets and zero forecast influence."]),
